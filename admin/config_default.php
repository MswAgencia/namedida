<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/namedida/admin/');
define('HTTP_CATALOG', 'http://localhost/namedida/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/namedida/admin/');
define('HTTPS_CATALOG', 'http://localhost/namedida/');
